/** Iconos simples tipo lucide para tipo de contenido */
...
export function IconCircleDot({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconPartyPopper({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M5.8 11.3L2 22l10.7-3.79" />
      <path d="M4 3l.7 2.3" />
      <path d="M22 2l-2 4-4-2 2-4" />
      <path d="M12 22l2-6 6-2-2 6" />
      <path d="M9.5 9.5L2 17l4.5-4.5" />
      <path d="M14.5 14.5L22 7l-4.5 4.5" />
    </svg>
  );
}
...
export function IconSparkles({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 3l1.875 5.625L19.5 10.5l-4.5 4.125 1.125 6L12 17.25l-4.125 3.375 1.125-6L4.5 10.5l5.625-1.875L12 3z" />
    </svg>
  );
}

/** Logo: estrella rellena (mismo que Landing/Couch Pick) */
export function IconLogoStar({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 32 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      <path d="M16 4l2.5 7.5L26 14l-6 5.5 1.5 8L16 22l-5.5 5.5 1.5-8L6 14l7.5-2.5L16 4z" />
    </svg>
  );
}
